...
const GoogleAnalytics = () => {
  const site = getCookie("siteDetail") || "undefined";
  const ccy_code =
    site != "undefined" &&
    site &&
  ...
  const addToCart = (item, state = false) => {
    if (
      ...
      //     currency: ccy_code,
      //     value:
      //       state && state.price_array
      //         ? state.price_array.SOL_VALUE
      //         : item.PRICE,
      //     items: [
      //       {
      //         card_type: "Quick By",
  ...
  const addToCartCustomizeGoogle = (item) => {
    if (site_url == "www.sedarglobal.com" && item && item.steps) {
      ...
      //               ]
      //             : "",
      //         item_list_name: item.product_info
      //           ? item.product_info.SPI_DESC
      //           : "",
  ...
  const purchase = (header_result, line_result, user_data) => {
      ...
      dataLayer.push({
        ...
        ecommerce: {
          ...
          mobile:
            user_data &&
            user_data.user_info &&
            user_data.user_info.cust_mobile_no
              ? user_data.user_info.cust_mobile_no
              : "",
          email:
            user_data &&
            user_data.user_info &&
            user_data.user_info.cust_email_id
              ? user_data.user_info.cust_email_id
              : "",
